...
class FVG_FoolsUtopiaInstance : public TVoxelGraphGeneratorInstanceHelper<FVG_FoolsUtopiaInstance, UVG_FoolsUtopia>
{
public:
	struct FParams
	{
	...
	private:
		...
		void Function0_XYWithCache_Compute(const FVoxelContext& Context, FBufferX& BufferX, FBufferXY& BufferXY) const
		{
			...
			Variable_1 = _2D_Perlin_Noise_Fractal_0_Noise.GetPerlinFractal_2D(BufferX.Variable_2, Variable_3, v_flt(0.001f), _2D_Perlin_Noise_Fractal_0_LODToOctaves[FMath::Clamp(Context.LOD, 0, 31)]);
			Variable_1 = FMath::Clamp<v_flt>(Variable_1, -0.601283, 0.600269);
			
			// 2D Noise SDF.*
			v_flt Variable_8; // 2D Noise SDF.* output 0
			Variable_8 = Variable_1 * v_flt(200.0f);
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContext& Context, FOutputs& Outputs) const
		{
			...
			// 2D Perlin Noise Fractal
			v_flt Variable_1; // 2D Perlin Noise Fractal output 0
			Variable_1 = _2D_Perlin_Noise_Fractal_0_Noise.GetPerlinFractal_2D(Variable_2, Variable_3, v_flt(0.001f), _2D_Perlin_Noise_Fractal_0_LODToOctaves[FMath::Clamp(Context.LOD, 0, 31)]);
			Variable_1 = FMath::Clamp<v_flt>(Variable_1, -0.601283, 0.600269);
	...
	public:
		...
		struct FBufferConstant
		{
			...
			int32 Variable_5; // Get Material Collection Index: Layer 1 output 0
			int32 Variable_6; // Get Material Collection Index: Layer 2 output 0
		...
		void Init(const FVoxelGeneratorInit& InitStruct)
		{
			...
			////////////////////////////////////////////////////
			{
				...
				////////////////////////////////////////////////////
				{
					...
					FVoxelGraphSeed Variable_8; // Make Seeds output 1
					Make_Seeds_1_Temp_0 = FVoxelUtilities::MurmurHash32(FVoxelGraphSeed(1337));
					Variable_8 = FVoxelUtilities::MurmurHash32(Make_Seeds_1_Temp_0);
			...
			////////////////////////////////////////////////////
			{
				...
				BufferConstant.Variable_5 = Get_Material_Collection_Index__Layer_1_0_Index;
				
				// Get Material Collection Index: Layer 2
				BufferConstant.Variable_6 = Get_Material_Collection_Index__Layer_2_0_Index;
	...
	private:
		...
		void Function0_XYZWithoutCache_Init(const FVoxelGeneratorInit& InitStruct)
		{
			...
			// Init of 2D Perlin Noise Fractal
			_2D_Perlin_Noise_Fractal_1_Noise.SetSeed(Variable_8);
		...
		void Function0_XYWithCache_Compute(const FVoxelContext& Context, FBufferX& BufferX, FBufferXY& BufferXY) const
		{
			...
			// 2D Perlin Noise Fractal
			v_flt Variable_11; // 2D Perlin Noise Fractal output 0
			Variable_11 = _2D_Perlin_Noise_Fractal_1_Noise.GetPerlinFractal_2D(BufferX.Variable_9, Variable_10, v_flt(0.02f), _2D_Perlin_Noise_Fractal_1_LODToOctaves[FMath::Clamp(Context.LOD, 0, 31)]);
			Variable_11 = FMath::Clamp<v_flt>(Variable_11, -0.306139, 0.328394);
			
			// *
			BufferXY.Variable_12 = Variable_11 * v_flt(25.0f);
		...
		void Function0_XYZWithCache_Compute(const FVoxelContext& Context, const FBufferX& BufferX, const FBufferXY& BufferXY, FOutputs& Outputs) const
		{
			...
			Variable_7 = Variable_4 + BufferXY.Variable_12;
			...
			v_flt Height_Splitter_0_Temp_3; // Height Splitter output 3
			{
				TVoxelStaticArray<v_flt, 6> InputsArray;
				TVoxelStaticArray<v_flt, 4> OutputsArray;
				InputsArray[0] = v_flt(-50.0f);
				InputsArray[1] = v_flt(5.0f);
				InputsArray[2] = v_flt(-10.0f);
				InputsArray[3] = v_flt(5.0f);
				InputsArray[4] = v_flt(0.0f);
				InputsArray[5] = v_flt(5.0f);
				FVoxelMathNodeFunctions::HeightSplit(Variable_7, InputsArray, OutputsArray);
				Variable_1 = OutputsArray[0];
				Variable_2 = OutputsArray[1];
				Variable_3 = OutputsArray[2];
				Height_Splitter_0_Temp_3 = OutputsArray[3];
			}
			
			Outputs.MaterialBuilder.AddMultiIndex(BufferConstant.Variable_0, Variable_1, bool(false));
			Outputs.MaterialBuilder.AddMultiIndex(BufferConstant.Variable_5, Variable_2, bool(false));
			Outputs.MaterialBuilder.AddMultiIndex(BufferConstant.Variable_6, Variable_3, bool(false));
		}
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContext& Context, FOutputs& Outputs) const
		{
			...
			// 2D Perlin Noise Fractal
			v_flt Variable_11; // 2D Perlin Noise Fractal output 0
			Variable_11 = _2D_Perlin_Noise_Fractal_1_Noise.GetPerlinFractal_2D(Variable_9, Variable_10, v_flt(0.02f), _2D_Perlin_Noise_Fractal_1_LODToOctaves[FMath::Clamp(Context.LOD, 0, 31)]);
			Variable_11 = FMath::Clamp<v_flt>(Variable_11, -0.306139, 0.328394);
			
			// *
			v_flt Variable_12; // * output 0
			Variable_12 = Variable_11 * v_flt(25.0f);
			
			// +
			v_flt Variable_7; // + output 0
			Variable_7 = Variable_4 + Variable_12;
	...
	public:
		...
		void Init(const FVoxelGeneratorInit& InitStruct)
		{
			...
			////////////////////////////////////////////////////
			{
				...
				Variable_5 = Variable_1 * TVoxelRange<v_flt>(200.0f);
	...
	FVG_FoolsUtopiaInstance(UVG_FoolsUtopia& Object)
...
template<>
inline v_flt FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalValue::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalValue::FOutputs::Set<v_flt, 1>(v_flt InValue)
{
	Value = InValue;
}
template<>
inline FVoxelMaterial FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Get<FVoxelMaterial, 2>() const
{
	return MaterialBuilder.Build();
}
template<>
inline void FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Set<FVoxelMaterial, 2>(FVoxelMaterial Material)
{
}
template<>
inline v_flt FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 3>() const
{
	return UpVectorX;
}
template<>
inline void FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 3>(v_flt InValue)
{
	UpVectorX = InValue;
}
template<>
inline v_flt FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 4>() const
{
	return UpVectorY;
}
template<>
inline void FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 4>(v_flt InValue)
{
	UpVectorY = InValue;
}
template<>
inline v_flt FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 5>() const
{
	return UpVectorZ;
}
template<>
inline void FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 5>(v_flt InValue)
{
	UpVectorZ = InValue;
}
template<>
inline TVoxelRange<v_flt> FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FVG_FoolsUtopiaInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Set<v_flt, 1>(TVoxelRange<v_flt> InValue)
{
	Value = InValue;
}
template<>
inline auto& FVG_FoolsUtopiaInstance::GetTarget<1>() const
{
	return LocalValue;
}
template<>
inline auto& FVG_FoolsUtopiaInstance::GetTarget<2>() const
{
	return LocalMaterial;
}
template<>
inline auto& FVG_FoolsUtopiaInstance::GetRangeTarget<0, 1>() const
{
	return LocalValueRangeAnalysis;
}
template<>
inline auto& FVG_FoolsUtopiaInstance::GetTarget<3, 4, 5>() const
{
...
UVG_FoolsUtopia::UVG_FoolsUtopia()
{
	bEnableRangeAnalysis = true;
}

TVoxelSharedRef<FVoxelTransformableGeneratorInstance> UVG_FoolsUtopia::GetTransformableInstance()
{
#if VOXEL_GRAPH_GENERATED_VERSION == 1
	return MakeVoxelShared<FVG_FoolsUtopiaInstance>(*this);
#else
#if VOXEL_GRAPH_GENERATED_VERSION > 1
	EMIT_CUSTOM_WARNING("Outdated generated voxel graph: VG_FoolsUtopia. You need to regenerate it.");
	FVoxelMessages::Warning("Outdated generated voxel graph: VG_FoolsUtopia. You need to regenerate it.");
#else
	EMIT_CUSTOM_WARNING("Generated voxel graph is more recent than the Voxel Plugin version: VG_FoolsUtopia. You need to update the plugin.");
	FVoxelMessages::Warning("Generated voxel graph is more recent than the Voxel Plugin version: VG_FoolsUtopia. You need to update the plugin.");
#endif
